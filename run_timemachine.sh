...
"sbt 'example_timemachine/run --gpu --train-data /data/time_machine/train.txt --test-data /data/time_machine/test.txt --epochs 500 --learning-rate 0.0001 --single --train-batch 1024 --validation-batch 128'"