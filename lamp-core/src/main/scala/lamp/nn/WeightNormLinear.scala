...
object WeightNormLinear {
  implicit val trainingMode: TrainingMode[WeightNormLinear] =
    TrainingMode.identity[WeightNormLinear]
  implicit val load: Load[WeightNormLinear] = Load.make[WeightNormLinear] {
    m => parameters =>
