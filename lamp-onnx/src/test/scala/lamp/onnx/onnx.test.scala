...
class OnnxSuite extends AnyFunSuite {
  ...
  testBinaryOps("Mul", List(3, 3), List(3, 3), _ => _ * _)
  testBinaryOps(
    "Mul Const",
    List(3, 3),
    List(3, 3),
  ...
  testBinaryOps(
    ...
    List(3, 3),
    List(3, 3),
    implicit sc => (a, b) => a.view(b.eval.shape)
  )
  testBinaryOps(
    "Cat",
    List(3, 3),
  ...
  testBinaryOps(
    ...
    List(3, 3),
    List(3, 3),
    _ => (a, b) => a.cat(b, 0).atan
  )
  testBinaryOps(
    "relu",
    List(3, 3),
    List(3, 3),
    _ => (a, b) => a.cat(b, 0).relu
  )
  testBinaryOps(
    "gelu",
    List(3, 3),
    List(3, 3),
    _ => (a, b) => a.cat(b, 0).gelu
  )
  testBinaryOps(
    "Pow Const",
    List(3, 3),
  ...
  testBinaryOps(
    ...
    List(3, 3),
    List(1),
    _ => (a, _) => a.sum(dim = List(0), keepDim = false)
  )
  testBinaryOps(
    "sum 2",
    List(3, 3),
    List(1),
    _ => (a, _) => a.sum(dim = List(0), keepDim = true)
  )
  testBinaryOps(
    "sum 3",
    List(3, 3),
    List(1),
    _ => (a, _) => a.mean(dim = List(), keepDim = false)
  )
  testBinaryOps(
    "mean 1",
    List(3, 3),
    List(1),
    _ => (a, _) => a.mean(dim = List(0), keepDim = false)
  )
  testBinaryOps(
    "mean 2",
    List(3, 3),
    List(1),
    _ => (a, _) => a.mean(dim = List(0), keepDim = true)
  )
  testBinaryOps(
    "mean 3",
    List(3, 3),
    List(1),
    _ => (a, _) => a.sum(dim = List(), keepDim = false)
  )
  testBinaryOps(
    "expand as",
    List(1),
    List(3, 3),
    implicit scope => (a, b) => a.expandAs(b.eval)
  )
  testBinaryOps(
    "bmm",
    List(3, 2, 3),
  ...
  testBinaryOps(
    ...
    List(2, 3),
    List(1),
    _ => (a, _) => a.dropout(prob = 0.5, train = false)
  )
  testBinaryOps(
    "flatten",
    List(2, 3, 3, 4),
  ...
  testBinaryOps(
    ...
    implicit scope =>
      (a, _) => {
        val i = (STen.zeros(List(5), STenOptions.l))
        a.indexSelect(0, i)
      }
  )
  // testBinaryOps(
  ...
  //   List(2, 3),
  //   List(2, 3),
  //   _ => (a, b) => new Stack(List(a,b), 1).value
  // )
