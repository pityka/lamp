...
"sbt 'example_translation/run --gpu --train-data /data/translation/clean.txt --epochs 100 --learning-rate 0.00001 --single --train-batch 180 --validation-batch 32 --checkpoint-save /persisted/checkpoint --checkpoint-load /persisted/checkpoint'"