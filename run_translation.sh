...
"sbt 'example_translation/run --gpu --train-data /data/translation/clean.txt --epochs 100 --learning-rate 0.0001 --single --train-batch 600 --validation-batch 32 --checkpoint-save /persisted/checkpoint'"