...
"sbt 'example_translation/run --gpu --train-data /data/translation/clean.txt --epochs 10 --learning-rate 0.0001 --single --train-batch 160 --validation-batch 32 --checkpoint-save checkpoint'"